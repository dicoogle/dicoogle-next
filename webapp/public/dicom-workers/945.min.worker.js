        ...
        o = (function () {
          ...
          function h(r, n, o, a, t, s, i, c, l) {
            ...
            function y(e, r, n, o, a) {
              var t = n % f;
              r(e, u(e, ((n / f) | 0) * e.v + o, t * e.h + a));
            }
            function D(e, r, n) {
              r(e, u(e, (n / e.blocksPerLine) | 0, n % e.blocksPerLine));
            }
            var L,
              x,
              T,
            ...
            for (
              ...
              if (((C = 0), 1 == q))
                for (L = a[0], U = 0; U < t; U++) (D(L, I, O), O++);
              else
                for (U = 0; U < t; U++) {
                  for (x = 0; x < q; x++)
                    for (z = (L = a[x]).h, H = L.v, T = 0; T < H; T++)
                      for (A = 0; A < z; A++) y(L, I, O, T, A);
                  O++;
                }
            ...
            Object.setPrototypeOf(p.prototype, {
              ...
              parse: function (r) {
                    ...
                    case 65498:
                      ...
                      for (J = 0; J < O; J++) {
                        ...
                        ((S.huffmanTableDC = p[Y >> 4]),
                          (S.huffmanTableAC = m[15 & Y]),
                          R.push(S));
                      }
                      var j = r[c++],
                        B = r[c++],
                        X = r[c++],
                        E = h(r, c, s, R, i, j, B, X >> 4, 15 & X);
                      c += E;
                      break;
                    case 65535:
                      255 !== r[c] && c--;
                ...
                for (var J = 0; J < s.components.length; J++) {
                  ...
                  ((S = s.components[J]).quantizationTable ||
                    ...
                    (S.quantizationTable = b[S.quantizationTableId]),
              ...
              getData16: function (e, r) {
                ...
                var n,
                  ...
                  l = this.height / r,
                  f = 0,
                  h = this.components.length,
                  b = new Uint16Array(e * r * h),
                  v = new Uint16Array(
                ...
                for (i = 0; i < g; i++) {
                  for (
                    var x,
                      T,
                      A,
                      U = (n = this.components[i]).blocksPerLine,
                      I = n.blocksPerColumn,
                      q = U << 3,
                      G = 0,
                      M = 0;
                    ...
                    for (var z = M << 3, H = 0; H < U; H++) {
                      ...
                      for (x = 0; x < 8; x++) {
                        G = (z + x) * q;
                        for (T = 0; T < 8; T++)
                          L[G + R + T] = n.output[O + P++] * n.bitConversion;
                      }
                    }
                  for (
                  ...
                  case 3:
                    if (
                      ...
                      for (i = 0; i < y; i += g)
                        ((c = D[i]),
                          (l = D[i + 1]),
                          (v = m(c - 179.456 + 1.402 * (f = D[i + 2]))),
                          (p = m(c + 135.459 - 0.344 * l - 0.714 * f)),
                          (d = m(c - 226.816 + 1.772 * l)),
                          (D[i] = v),
                          (D[i + 1] = p),
                          (D[i + 2] = d));
                    break;
                  case 4:
                    ...
                    if (
                      ...
                      for (i = 0; i < y; i += g)
                        ((c = D[i]),
                          (l = D[i + 1]),
                          (h = m(434.456 - c - 1.402 * (f = D[i + 2]))),
                          (b = m(119.541 - c + 0.344 * l + 0.714 * f)),
                          (c = m(481.816 - c - 1.772 * l)),
                          (D[i] = h),
                          (D[i + 1] = b),
                          (D[i + 2] = c));
                    break;
