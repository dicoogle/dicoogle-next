 ...
 * org.dicoogle.sdk.query.StorageIngestEventListener} plugins when a storage write could not be
 * completed. The DICOM hierarchy identifiers included in this event reflect whatever information
 * was available at the point of failure; some fields may be empty if the failure occurred early in
 * processing.
 *
