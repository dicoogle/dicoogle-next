 ...
 *
 * <p>This interface is a lower-level, storage-centric sibling of
 * {@link org.dicoogle.sdk.query.QueryIndexStorageLocator}. Whereas
 * {@code QueryIndexStorageLocator} is a query-index plugin extension point,
 * {@code DicomInstanceLocator} is a pure storage-side utility that can be implemented by any
 * component with direct access to a storage backend — it does not extend
 * {@link org.dicoogle.sdk.DicooglePlugin}.
 *
 * <p>All methods may return an empty result if the requested identifiers are not known; they
