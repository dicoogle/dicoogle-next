 ...
 *
 * <p>This event is published when a C-MOVE sub-operation (or DICOMWeb WADO-RS transfer) cannot
 * be completed. The HTTP status code field follows the DICOMWeb convention even for DIMSE
 * retrievals, where it is mapped from the DIMSE status code by the protocol layer.
 *
 ...
 * @param httpStatus        the HTTP-equivalent status code (e.g. {@code 404} for not found,
