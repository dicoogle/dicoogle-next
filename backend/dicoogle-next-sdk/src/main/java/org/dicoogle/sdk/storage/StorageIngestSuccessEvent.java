 ...
 * plugins after the storage backend confirms a successful write. The included DICOM hierarchy
 * identifiers and storage URI are sufficient for an index plugin to record the mapping without
 * re-reading the file.
 *
 ...
 * @param storageScheme       the URI scheme of the backend that stored the instance
 *                            (e.g. {@code "file"}, {@code "s3"})
